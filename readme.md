...
- [Real-time Communications Security](https://github.com/EnableSecurity/awesome-rtc-hacking#readme) - Security resources focused on VoIP, WebRTC and VoLTE penetration testing, security research and vulnerability assessment.
